...
class CelasDataGridWidget extends ConsumerStatefulWidget {
  const CelasDataGridWidget({Key? key, required this.size}) : super(key: key);
  final Size size;
  @override
  _CelasDataGridWidgetState createState() => _CelasDataGridWidgetState();
}

class _CelasDataGridWidgetState extends ConsumerState<CelasDataGridWidget> {
